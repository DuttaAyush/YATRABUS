...
export default function IndiaLocalHero() {
  return (
    <>
      {/* HERO BANNER */}
      <section className="relative min-h-[580px] lg:min-h-[640px] flex items-center justify-center text-white overflow-hidden pb-28 pt-12" data-purpose="hero-banner">
