              ...
              <div className="flex items-center justify-between p-3.5 sm:p-4 bg-emerald-50/70 rounded-2xl border border-emerald-200/80 mb-3 shrink-0">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-wider shadow-md flex items-center gap-1.5"
                  >
